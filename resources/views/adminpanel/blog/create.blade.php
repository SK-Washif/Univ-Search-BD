...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    @endif
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Blog / </span> Create</h4>
    <div class="row">
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('blog.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="basic-default-title">Title <span style="color: red;">*</span></label>
                            <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="basic-default-tag" placeholder="Enter tags separated by commas. Ex: anime,manga,comic"
                                    name="tag" />
                            </div>
                        </div>

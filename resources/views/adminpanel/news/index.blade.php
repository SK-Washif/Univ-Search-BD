        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="my-auto">
                <a href="{{ route('news.create') }}">
                    <button class="btn btn-info rounded-pill">Add News</button>
                </a>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($data->images->isNotEmpty())
                                            <img src="{{ asset($data->images[0]->url) }}" alt="News Image"
                                    ...
                                    <td>
                                        <form method="POST"
                                            action="{{ route('update-news-status', ['id' => $data->id]) }}">
                                            @csrf
                                            <button type="submit"
                                    ...
                                    <td>
                                        <a href="{{ route('news.edit', $data->id) }}" class="btn btn-primary btn-sm"><i
                                                class="fa fa-pencil"></i></a>
                                        <a href="#"
                                            onclick="if(!confirm('Are you sure you want to delete this news?')){event.preventDefault();}else{document.getElementById('delete-form-{{ $key }}').submit();}"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered"
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="modalScrollableTitle">News Full Details</h5>
